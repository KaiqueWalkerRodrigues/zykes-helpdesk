...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { name: "Empresas", path: "/configuracoes/empresas", pro: false },
      { name: "Setores", path: "/configuracoes/setores", pro: false },
...
const AppSidebar: React.FC = () => {
  ...
  const handleSubmenuToggle = (index: number, menuType: "main" | "outros") => {
  ...
  const renderMenuItems = (items: NavItem[], menuType: "main" | "outros") => (
        ...
        <nav className="mb-6">
          <div className="flex flex-col gap-4">
            ...
            {/* <div className="">
              ...
              {renderMenuItems(othersItems, "outros")}
            </div> */}
          </div>
        </nav>
      </div>
